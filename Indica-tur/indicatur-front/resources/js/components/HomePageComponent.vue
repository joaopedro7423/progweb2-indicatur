<template>
  <div>
      <!-- Navigation -->
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Acompanhe nosso blog com promoções de viagens e matérias sobre viagens de turismo.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <p class="text-muted">Nosso sistema permite que você possa transferir seus bônus para algum indicado, 
        ...
        <!-- Portfolio Grid -->
        <section class="bg-light" id="itinerario">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                ...
                <div class="row al-center">
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="img/indicatur/Belo Horizonte.jpg" alt="">
                        </a>
                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">Viagem para Belo Horizonte no valor de R$ 160,00 reais.</p>
                                    <img class="img-fluid d-block mx-auto" src="img/indicatur/Belo Horizonte.jpg" alt="">
